...
import { dataHrdinu } from "./data.js";
...
for (const data of dataHrdinu) {
    ...
    switch (data.typ) {
        case "valecnik":
            hrdina = new Valecnik(data.id, data.jmeno, data.level, data.sila, data.obratnost, data.inteligence, data.vydrz, data.rasa);
            break;
        case "mag":
            hrdina = new Mag(data.id, data.jmeno, data.level, data.sila, data.obratnost, data.inteligence, data.vydrz, data.rasa);
            break;
        case "lukostrelec":
            hrdina = new Lukostrelec(data.id, data.jmeno, data.level, data.sila, data.obratnost, data.inteligence, data.vydrz, data.rasa);
            break;
        default:
